<div align="center">
  ...
  <p>
    <a href="https://github.com/antoniomml/chordleaf/releases/tag/v0.5.0"><img src="https://img.shields.io/badge/version-0.5.0-c9e79c?style=flat-square&labelColor=263426" alt="Release 0.5.0"></a>
...
**0.5.0** improves the empty workspace for new users, reduces typing lag in long songs, strengthens keyboard and screen-reader labels, and publishes crawlable bilingual feature descriptions with consolidated English canonical URLs. Vercel rate-limits the public song importer. Chordleaf retains its bilingual workspace, complete backups and bounded imports. Scanned PDFs require external OCR, complex layouts may need corrections after import, and Word rendering depends on the reader and available fonts. Audio transcription is not available yet. See the [changelog](CHANGELOG.md).
