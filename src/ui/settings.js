...
export function renderDocumentSettings(s, key, transposeInfo = null) {
  return t`<h2 class="panel-title"><span>El documento</span><span class="muted">01</span></h2>
    ...
    <div id="document-options-content">
      ...
      <label class="field"><input id="showBrand" type="checkbox" ${s.showBrand !== false ? "checked" : ""}> Mostrar chordleaf.com al pie de la hoja</label>
      ...
      <label class="field">INTERVALO <select id="transpose-interval" aria-label="Intervalo de transposición"><option value="1">½ tono · 1 semitono</option><option value="2">1 tono · 2 semitonos</option><option value="4">2 tonos · 4 semitonos</option></select></label>
