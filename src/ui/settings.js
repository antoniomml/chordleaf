...
export function renderDocumentSettings(s, key) {
  return t`<h2 class="panel-title"><span>El documento</span><span class="muted">01</span></h2>
    ...
    <button id="document-options-toggle" type="button" aria-controls="document-options-content" aria-expanded="false">Opciones de la hoja <span aria-hidden="true">⌄</span></button>
